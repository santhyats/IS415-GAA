...
I will also be creating a separate sf containing the timeframe and the geometry, to be used in our Spatio Temporal KDE layers later.
...
I will now use the combined ppp object to derive the quarterly KDE layers, sorted by the different conflict types.
...
battles_k = Kest(battles_ppp_com, correction = "Ripley") 
battles_k.csr <- envelope(battles_ppp_com, Kest, nsim = 39, rank = 1, glocal=TRUE)
plot(battles_k.csr, . -r ~ r, ylab= "K(d)-r", xlab = "d(m)")
...
battles_q121_k = Kest(battlesQ121_ppp_com, correction = "Ripley") 
battles_q121_k.csr <- envelope(battlesQ121_ppp_com, Kest, nsim = 39, rank = 1, glocal=TRUE)

battles_q221_k <- Kest(battlesQ221_ppp_com, correction = "Ripley") 
battles_q221_k.csr <- envelope(battlesQ221_ppp_com, Kest, nsim = 39, rank = 1, glocal=TRUE)

battles_q321_k <- Kest(battlesQ321_ppp_com, correction = "Ripley") 
battles_q321_k.csr <- envelope(battlesQ321_ppp_com, Kest, nsim = 39, rank = 1, glocal=TRUE)


battles_q421_k <- Kest(battlesQ421_ppp_com, correction = "Ripley") 
battles_q421_k.csr <- envelope(battlesQ421_ppp_com, Kest, nsim = 39, rank = 1, glocal=TRUE)

par(mfrow=c(2,2))
plot(battles_q121_k.csr, . -r ~ r, ylab= "K(d)-r", xlab = "d(m)")
plot(battles_q221_k.csr, . -r ~ r, ylab= "K(d)-r", xlab = "d(m)")
plot(battles_q321_k.csr, . -r ~ r, ylab= "K(d)-r", xlab = "d(m)")
plot(battles_q421_k.csr, . -r ~ r, ylab= "K(d)-r", xlab = "d(m)")
...
battles_q122_k <- Kest(battlesQ122_ppp_com, correction = "Ripley") 
battles_q122_k.csr <- envelope(battlesQ122_ppp_com, Kest, nsim = 39, rank = 1, glocal=TRUE)


battles_q222_k <- Kest(battlesQ222_ppp_com, correction = "Ripley") 
battles_q222_k.csr <- envelope(battlesQ222_ppp_com, Kest, nsim = 39, rank = 1, glocal=TRUE)

battles_q322_k <- Kest(battlesQ322_ppp_com, correction = "Ripley") 
battles_q322_k.csr <- envelope(battlesQ322_ppp_com, Kest, nsim = 39, rank = 1, glocal=TRUE)


battles_q422_k <- Kest(battlesQ422_ppp_com, correction = "Ripley") 
battles_q422_k.csr <- envelope(battlesQ422_ppp_com, Kest, nsim = 39, rank = 1, glocal=TRUE)

par(mfrow=c(2,2))
plot(battles_q122_k.csr, . -r ~ r, ylab= "K(d)-r", xlab = "d(m)")
plot(battles_q222_k.csr, . -r ~ r, ylab= "K(d)-r", xlab = "d(m)")
plot(battles_q322_k.csr, . -r ~ r, ylab= "K(d)-r", xlab = "d(m)")
plot(battles_q422_k.csr, . -r ~ r, ylab= "K(d)-r", xlab = "d(m)")
...
```{r}
battles_q123_k <- Kest(battlesQ123_ppp_com, correction = "Ripley") 
battles_q123_k.csr <- envelope(battlesQ123_ppp_com, Kest, nsim = 39, rank = 1, glocal=TRUE)


battles_q223_k <- Kest(battlesQ223_ppp_com, correction = "Ripley") 
battles_q223_k.csr <- envelope(battlesQ223_ppp_com, Kest, nsim = 39, rank = 1, glocal=TRUE)

battles_q323_k <- Kest(battlesQ323_ppp_com, correction = "Ripley") 
battles_q323_k.csr <- envelope(battlesQ323_ppp_com, Kest, nsim = 39, rank = 1, glocal=TRUE)


battles_q423_k <- Kest(battlesQ423_ppp_com, correction = "Ripley") 
battles_q423_k.csr <- envelope(battlesQ423_ppp_com, Kest, nsim = 39, rank = 1, glocal=TRUE)

par(mfrow=c(2,2))
plot(battles_q123_k.csr, . -r ~ r, ylab= "K(d)-r", xlab = "d(m)")
plot(battles_q223_k.csr, . -r ~ r, ylab= "K(d)-r", xlab = "d(m)")
plot(battles_q323_k.csr, . -r ~ r, ylab= "K(d)-r", xlab = "d(m)")
plot(battles_q423_k.csr, . -r ~ r, ylab= "K(d)-r", xlab = "d(m)")
```
...
battles_q124_k <- Kest(battlesQ124_ppp_com, correction = "Ripley") 
battles_q124_k.csr <- envelope(battlesQ124_ppp_com, Kest, nsim = 39, rank = 1, glocal=TRUE)


battles_q224_k <- Kest(battlesQ224_ppp_com, correction = "Ripley") 
battles_q224_k.csr <- envelope(battlesQ224_ppp_com, Kest, nsim = 39, rank = 1, glocal=TRUE)

par(mfrow=c(1,2))
plot(battles_q124_k.csr, . -r ~ r, ylab= "K(d)-r", xlab = "d(m)")
plot(battles_q224_k.csr, . -r ~ r, ylab= "K(d)-r", xlab = "d(m)")
```
:::
...
exp_q121_k = Kest(expQ121_ppp_com, correction = "Ripley") 
exp_q121_k.csr <- envelope(expQ121_ppp_com, Kest, nsim = 39, rank = 1, glocal=TRUE)

exp_q221_k <- Kest(expQ221_ppp_com, correction = "Ripley") 
exp_q221_k.csr <- envelope(expQ221_ppp_com, Kest, nsim = 39, rank = 1, glocal=TRUE)

exp_q321_k <- Kest(expQ321_ppp_com, correction = "Ripley") 
exp_q321_k.csr <- envelope(expQ321_ppp_com, Kest, nsim = 39, rank = 1, glocal=TRUE)

exp_q421_k <- Kest(expQ421_ppp_com, correction = "Ripley") 
exp_q421_k.csr <- envelope(expQ421_ppp_com, Kest, nsim = 39, rank = 1, glocal=TRUE)

par(mfrow=c(2,2))
plot(exp_q121_k.csr, . -r ~ r, ylab= "K(d)-r", xlab = "d(m)")
plot(exp_q221_k.csr, . -r ~ r, ylab= "K(d)-r", xlab = "d(m)")
plot(exp_q321_k.csr, . -r ~ r, ylab= "K(d)-r", xlab = "d(m)")
plot(exp_q421_k.csr, . -r ~ r, ylab= "K(d)-r", xlab = "d(m)")
...
exp_q122_k <- Kest(expQ122_ppp_com, correction = "Ripley") 
exp_q122_k.csr <- envelope(expQ122_ppp_com, Kest, nsim = 39, rank = 1, glocal=TRUE)


exp_q222_k <- Kest(expQ222_ppp_com, correction = "Ripley") 
exp_q222_k.csr <- envelope(expQ222_ppp_com, Kest, nsim = 39, rank = 1, glocal=TRUE)

exp_q322_k <- Kest(expQ322_ppp_com, correction = "Ripley") 
exp_q322_k.csr <- envelope(expQ322_ppp_com, Kest, nsim = 39, rank = 1, glocal=TRUE)


exp_q422_k <- Kest(expQ422_ppp_com, correction = "Ripley") 
exp_q422_k.csr <- envelope(expQ422_ppp_com, Kest, nsim = 39, rank = 1, glocal=TRUE)

par(mfrow=c(2,2))
plot(exp_q122_k.csr, . -r ~ r, ylab= "K(d)-r", xlab = "d(m)")
plot(exp_q222_k.csr, . -r ~ r, ylab= "K(d)-r", xlab = "d(m)")
plot(exp_q322_k.csr, . -r ~ r, ylab= "K(d)-r", xlab = "d(m)")
plot(exp_q422_k.csr, . -r ~ r, ylab= "K(d)-r", xlab = "d(m)")
...
exp_q123_k <- Kest(expQ123_ppp_com, correction = "Ripley") 
exp_q123_k.csr <- envelope(expQ123_ppp_com, Kest, nsim = 39, rank = 1, glocal=TRUE)


exp_q223_k <- Kest(expQ223_ppp_com, correction = "Ripley") 
exp_q223_k.csr <- envelope(expQ223_ppp_com, Kest, nsim = 39, rank = 1, glocal=TRUE)

exp_q323_k <- Kest(expQ323_ppp_com, correction = "Ripley") 
exp_q323_k.csr <- envelope(expQ323_ppp_com, Kest, nsim = 39, rank = 1, glocal=TRUE)


exp_q423_k <- Kest(expQ423_ppp_com, correction = "Ripley") 
exp_q423_k.csr <- envelope(expQ423_ppp_com, Kest, nsim = 39, rank = 1, glocal=TRUE)

par(mfrow=c(2,2))
plot(exp_q123_k.csr, . -r ~ r, ylab= "K(d)-r", xlab = "d(m)")
plot(exp_q223_k.csr, . -r ~ r, ylab= "K(d)-r", xlab = "d(m)")
plot(exp_q323_k.csr, . -r ~ r, ylab= "K(d)-r", xlab = "d(m)")
plot(exp_q423_k.csr, . -r ~ r, ylab= "K(d)-r", xlab = "d(m)")
```

## 2024

```{r}
exp_q124_k <- Kest(expQ124_ppp_com, correction = "Ripley") 
exp_q124_k.csr <- envelope(expQ124_ppp_com, Kest, nsim = 39, rank = 1, glocal=TRUE)


exp_q224_k <- Kest(expQ224_ppp_com, correction = "Ripley") 
exp_q224_k.csr <- envelope(expQ224_ppp_com, Kest, nsim = 39, rank = 1, glocal=TRUE)

par(mfrow=c(1,2))
plot(exp_q124_k.csr, . -r ~ r, ylab= "K(d)-r", xlab = "d(m)")
plot(exp_q224_k.csr, . -r ~ r, ylab= "K(d)-r", xlab = "d(m)")
...
strat_dev_q121_k = Kest(strat_devQ121_ppp_com, correction = "Ripley") 
strat_dev_q121_k.csr <- envelope(strat_devQ121_ppp_com, Kest, nsim = 39, rank = 1, glocal=TRUE)

strat_dev_q221_k <- Kest(strat_devQ221_ppp_com, correction = "Ripley") 
strat_dev_q221_k.csr <- envelope(strat_devQ221_ppp_com, Kest, nsim = 39, rank = 1, glocal=TRUE)

strat_dev_q321_k <- Kest(strat_devQ321_ppp_com, correction = "Ripley") 
strat_dev_q321_k.csr <- envelope(strat_devQ321_ppp_com, Kest, nsim = 39, rank = 1, glocal=TRUE)

strat_dev_q421_k <- Kest(strat_devQ421_ppp_com, correction = "Ripley") 
strat_dev_q421_k.csr <- envelope(strat_devQ421_ppp_com, Kest, nsim = 39, rank = 1, glocal=TRUE)

par(mfrow=c(2,2))
plot(strat_dev_q121_k.csr, . -r ~ r, ylab= "K(d)-r", xlab = "d(m)")
plot(strat_dev_q221_k.csr, . -r ~ r, ylab= "K(d)-r", xlab = "d(m)")
plot(strat_dev_q321_k.csr, . -r ~ r, ylab= "K(d)-r", xlab = "d(m)")
plot(strat_dev_q421_k.csr, . -r ~ r, ylab= "K(d)-r", xlab = "d(m)")
```
...
strat_dev_q122_k = Kest(strat_devQ122_ppp_com, correction = "Ripley") 
strat_dev_q122_k.csr <- envelope(strat_devQ122_ppp_com, Kest, nsim = 39, rank = 1, glocal=TRUE)

strat_dev_q222_k <- Kest(strat_devQ222_ppp_com, correction = "Ripley") 
strat_dev_q222_k.csr <- envelope(strat_devQ222_ppp_com, Kest, nsim = 39, rank = 1, glocal=TRUE)

strat_dev_q322_k <- Kest(strat_devQ322_ppp_com, correction = "Ripley") 
strat_dev_q322_k.csr <- envelope(strat_devQ322_ppp_com, Kest, nsim = 39, rank = 1, glocal=TRUE)

strat_dev_q422_k <- Kest(strat_devQ422_ppp_com, correction = "Ripley") 
strat_dev_q422_k.csr <- envelope(strat_devQ422_ppp_com, Kest, nsim = 39, rank = 1, glocal=TRUE)

par(mfrow=c(2,2))
plot(strat_dev_q122_k.csr, . -r ~ r, ylab= "K(d)-r", xlab = "d(m)")
plot(strat_dev_q222_k.csr, . -r ~ r, ylab= "K(d)-r", xlab = "d(m)")
plot(strat_dev_q322_k.csr, . -r ~ r, ylab= "K(d)-r", xlab = "d(m)")
plot(strat_dev_q422_k.csr, . -r ~ r, ylab= "K(d)-r", xlab = "d(m)")
```
...
strat_dev_q123_k = Kest(strat_devQ123_ppp_com, correction = "Ripley") 
strat_dev_q123_k.csr <- envelope(strat_devQ123_ppp_com, Kest, nsim = 39, rank = 1, glocal=TRUE)

strat_dev_q223_k <- Kest(strat_devQ223_ppp_com, correction = "Ripley") 
strat_dev_q223_k.csr <- envelope(strat_devQ223_ppp_com, Kest, nsim = 39, rank = 1, glocal=TRUE)

strat_dev_q323_k <- Kest(strat_devQ323_ppp_com, correction = "Ripley") 
strat_dev_q323_k.csr <- envelope(strat_devQ323_ppp_com, Kest, nsim = 39, rank = 1, glocal=TRUE)

strat_dev_q423_k <- Kest(strat_devQ423_ppp_com, correction = "Ripley") 
strat_dev_q423_k.csr <- envelope(strat_devQ423_ppp_com, Kest, nsim = 39, rank = 1, glocal=TRUE)

par(mfrow=c(2,2))
plot(strat_dev_q123_k.csr, . -r ~ r, ylab= "K(d)-r", xlab = "d(m)")
plot(strat_dev_q223_k.csr, . -r ~ r, ylab= "K(d)-r", xlab = "d(m)")
plot(strat_dev_q323_k.csr, . -r ~ r, ylab= "K(d)-r", xlab = "d(m)")
plot(strat_dev_q423_k.csr, . -r ~ r, ylab= "K(d)-r", xlab = "d(m)")
```
...
strat_dev_q124_k = Kest(strat_devQ124_ppp_com, correction = "Ripley") 
strat_dev_q124_k.csr <- envelope(strat_devQ124_ppp_com, Kest, nsim = 39, rank = 1, glocal=TRUE)

strat_dev_q224_k <- Kest(strat_devQ224_ppp_com, correction = "Ripley") 
strat_dev_q224_k.csr <- envelope(strat_devQ224_ppp_com, Kest, nsim = 39, rank = 1, glocal=TRUE)

par(mfrow=c(1,2))
plot(strat_dev_q124_k.csr, . -r ~ r, ylab= "K(d)-r", xlab = "d(m)")
plot(strat_dev_q224_k.csr, . -r ~ r, ylab= "K(d)-r", xlab = "d(m)")
...
civViolence_q121_k = Kest(civViolenceQ121_ppp_com, correction = "Ripley") 
civViolence_q121_k.csr <- envelope(civViolenceQ121_ppp_com, Kest, nsim = 39, rank = 1, glocal=TRUE)

civViolence_q221_k <- Kest(civViolenceQ221_ppp_com, correction = "Ripley") 
civViolence_q221_k.csr <- envelope(civViolenceQ221_ppp_com, Kest, nsim = 39, rank = 1, glocal=TRUE)

civViolence_q321_k <- Kest(civViolenceQ321_ppp_com, correction = "Ripley") 
civViolence_q321_k.csr <- envelope(civViolenceQ321_ppp_com, Kest, nsim = 39, rank = 1, glocal=TRUE)

civViolence_q421_k <- Kest(civViolenceQ421_ppp_com, correction = "Ripley") 
civViolence_q421_k.csr <- envelope(civViolenceQ421_ppp_com, Kest, nsim = 39, rank = 1, glocal=TRUE)

par(mfrow=c(2,2))
plot(civViolence_q121_k.csr, . -r ~ r, ylab= "K(d)-r", xlab = "d(m)")
plot(civViolence_q221_k.csr, . -r ~ r, ylab= "K(d)-r", xlab = "d(m)")
plot(civViolence_q321_k.csr, . -r ~ r, ylab= "K(d)-r", xlab = "d(m)")
plot(civViolence_q421_k.csr, . -r ~ r, ylab= "K(d)-r", xlab = "d(m)")
...
civViolence_q122_k = Kest(civViolenceQ122_ppp_com, correction = "Ripley") 
civViolence_q122_k.csr <- envelope(civViolenceQ122_ppp_com, Kest, nsim = 39, rank = 1, glocal=TRUE)

civViolence_q222_k <- Kest(civViolenceQ222_ppp_com, correction = "Ripley") 
civViolence_q222_k.csr <- envelope(civViolenceQ222_ppp_com, Kest, nsim = 39, rank = 1, glocal=TRUE)

civViolence_q322_k <- Kest(civViolenceQ322_ppp_com, correction = "Ripley") 
civViolence_q322_k.csr <- envelope(civViolenceQ322_ppp_com, Kest, nsim = 39, rank = 1, glocal=TRUE)

civViolence_q422_k <- Kest(civViolenceQ422_ppp_com, correction = "Ripley") 
civViolence_q422_k.csr <- envelope(civViolenceQ422_ppp_com, Kest, nsim = 39, rank = 1, glocal=TRUE)

par(mfrow=c(2,2))
plot(civViolence_q122_k.csr, . -r ~ r, ylab= "K(d)-r", xlab = "d(m)")
plot(civViolence_q222_k.csr, . -r ~ r, ylab= "K(d)-r", xlab = "d(m)")
plot(civViolence_q322_k.csr, . -r ~ r, ylab= "K(d)-r", xlab = "d(m)")
plot(civViolence_q422_k.csr, . -r ~ r, ylab= "K(d)-r", xlab = "d(m)")
```
...
civViolence_q123_k = Kest(civViolenceQ123_ppp_com, correction = "Ripley") 
civViolence_q123_k.csr <- envelope(civViolenceQ123_ppp_com, Kest, nsim = 39, rank = 1, glocal=TRUE)

civViolence_q223_k <- Kest(civViolenceQ223_ppp_com, correction = "Ripley") 
civViolence_q223_k.csr <- envelope(civViolenceQ223_ppp_com, Kest, nsim = 39, rank = 1, glocal=TRUE)

civViolence_q323_k <- Kest(civViolenceQ323_ppp_com, correction = "Ripley") 
civViolence_q323_k.csr <- envelope(civViolenceQ323_ppp_com, Kest, nsim = 39, rank = 1, glocal=TRUE)

civViolence_q423_k <- Kest(civViolenceQ423_ppp_com, correction = "Ripley") 
civViolence_q423_k.csr <- envelope(civViolenceQ423_ppp_com, Kest, nsim = 39, rank = 1, glocal=TRUE)

par(mfrow=c(2,2))
plot(civViolence_q123_k.csr, . -r ~ r, ylab= "K(d)-r", xlab = "d(m)")
plot(civViolence_q223_k.csr, . -r ~ r, ylab= "K(d)-r", xlab = "d(m)")
plot(civViolence_q323_k.csr, . -r ~ r, ylab= "K(d)-r", xlab = "d(m)")
plot(civViolence_q423_k.csr, . -r ~ r, ylab= "K(d)-r", xlab = "d(m)")
```
...
civViolence_q124_k = Kest(civViolenceQ124_ppp_com, correction = "Ripley") 
civViolence_q124_k.csr <- envelope(civViolenceQ124_ppp_com, Kest, nsim = 39, rank = 1, glocal=TRUE)

civViolence_q224_k <- Kest(civViolenceQ224_ppp_com, correction = "Ripley") 
civViolence_q224_k.csr <- envelope(civViolenceQ224_ppp_com, Kest, nsim = 39, rank = 1, glocal=TRUE)

par(mfrow=c(1,2))
plot(civViolence_q124_k.csr, . -r ~ r, ylab= "K(d)-r", xlab = "d(m)")
plot(civViolence_q224_k.csr, . -r ~ r, ylab= "K(d)-r", xlab = "d(m)")

```
:::
:::

## 1.5 Computing the Quarterly Spatio-Temporal KDE Layers
...
```{r}
strat_dev_st_21<- quart_geo_strat_dev %>% 
  filter(year=="2021") %>% 
  select(2,3)
...
```{r}
strat_dev_st_22<- quart_geo_strat_dev %>% 
  filter(year=="2022") %>% 
  select(2,3)
...
```{r}
strat_dev_st_23<- quart_geo_strat_dev %>% 
  filter(year=="2023") %>% 
  select(2,3)
