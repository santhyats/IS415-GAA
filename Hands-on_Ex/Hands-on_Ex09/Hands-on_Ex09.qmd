...
```{r}
pacman::p_load(sf, tidyverse, tmap, corrplot, GWmodel, olsrr)
```
...
We will also look at the geospatial distribution of condominium resale prices in Singapore using functions of the **tmap** package. First, we will turn on the interactive mode of tmap.
...
We will set the mode to plot before moving on.
